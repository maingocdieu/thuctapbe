...
import com.maingocdieu.SportShop.payload.reponse.JwtResponse;
import com.maingocdieu.SportShop.payload.reponse.MessageResponse;
import com.maingocdieu.SportShop.payload.request.LoginRequest;
import com.maingocdieu.SportShop.payload.request.SignupRequest;
import com.maingocdieu.SportShop.repository.RoleRepository;
import com.maingocdieu.SportShop.repository.UserRepository;
import com.maingocdieu.SportShop.security.jwt.JwtUtils;
import com.maingocdieu.SportShop.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (userRepository.existsByEmail(signUpRequest.getEmail())) {
			return ResponseEntity
					.badRequest()
					.body(new MessageResponse("Error: emil đã tồn tại!"));
		}
